/*WAP to find the average expenditure of a company for each month of each year,
...
int main()
{
    ...
    int no_year = end_year - start_year + 1;
    int expenditure[12][no_year];

    char months[12][5] = {"Jan.", "Feb.", "Mar.", "Apr.", "May", "Jun.",
                          "Jul.", "Aug.", "Sep.", "Oct.", "Nov.", "Dec."};

    // Get the expenditure from user
    ...
    // To display the expenditure table
    printf("\nExpenditure table:\n");
    ...
    for (int i = 0; i < 12; ++i)
    {
        printf("%7.2f |", monthly_sum[i] / (float)no_year);
    }
